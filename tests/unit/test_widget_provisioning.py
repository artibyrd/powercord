...
def test_widget_provisioning_enable(session):
    ...
    try:
        ...
        auditor_settings_widget = next(w for w in widgets if w.widget_name == "guild_admin_auditor_settings")
        ...
        # Audit roles widget
        audit_roles_widget = next(w for w in widgets if w.widget_name == "guild_admin_audit_roles")
        ...
        audit_channels_widget = next(w for w in widgets if w.widget_name == "guild_admin_audit_channels")
        ...
        audit_permissions_widget = next(w for w in widgets if w.widget_name == "guild_admin_audit_permissions")
